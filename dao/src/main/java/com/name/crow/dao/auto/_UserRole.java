...
public abstract class _UserRole extends CayenneDataObject {
    ...
    public void addToUserid(UserAccount obj) {
        addToManyTarget(USERID_PROPERTY, obj, true);
    }

    public void removeFromUserid(UserAccount obj) {
        removeToManyTarget(USERID_PROPERTY, obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<UserAccount> getUserid() {
        return (List<UserAccount>) readProperty(USERID_PROPERTY);
    }
